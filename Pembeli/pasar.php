							...
							<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="barang<?php echo $row['id']; ?>" class="modal fade">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<form method="POST" action="penawaran.php">
											<div class="modal-body">
												<div class="row">
													...
													<div class="col">
														<input type="num" name="id_brg" value="<?php echo $row['id']; ?>" hidden>
														<input type="num" name="id_penj" value="<?php echo $row['id_pengguna']; ?>" hidden>
														<input type="num" name="id_pemb" value="<?php echo $sid; ?>" hidden>
